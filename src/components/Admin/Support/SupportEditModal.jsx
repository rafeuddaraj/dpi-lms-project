...
export default function SupportEditModal({ showModal, handleModal }) {
    const [input, setInput] = useState(initialInput);
    const [updateSupport, { isLoading }] = useUpdateSupportMutation();
    const { supportId } = useSelector((state) => state.supports);
    const { data: support, isSuccess } = useGetSupportQuery(supportId);
    const handleInput = (e) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        updateSupport({ id: supportId, data: {...input} })
            .unwrap()
            .then(() => {
                handleModal();
            });
