...
import { useAddVideoMutation } from "../../../features/videoSlice/videoApi";
...
export default function VideoAddModal({ showModal, handleModal }) {
    const [input, setInput] = useState(initialInput);
    const [addVideo, { isLoading: isAddVideoLoading }] = useAddVideoMutation();
