...
} from "../../../features/videoSlice/videoApi";
...
export default function VideoEditModal({ showModal, handleModal }) {
    const { videoId } = useSelector((state) => state.videos);
    const { data: video, isLoading, isSuccess } = useGetVideoQuery(videoId);
    const [input, setInput] = useState(initialInput);
    const [updateVideo, { isLoading: isUpdatingLoading }] =
        useUpdateVideoMutation();
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        updateVideo({ data: input, id: videoId });
        handleModal();
    };
